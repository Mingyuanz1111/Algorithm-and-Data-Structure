...
3) push แต่ละ vertex ที่อยู่ติดกับ `cur` และยังไม่เคยถูกเพิ่มใส่ queue เข้าไปใน queue และ**จด vertex เหล่านี้ว่าถูกเพิ่มใส่ใน queue แล้ว ทันทีหลังจากเพิ่มเข้า queue**  
